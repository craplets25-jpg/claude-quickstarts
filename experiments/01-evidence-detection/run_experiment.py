#!/usr/bin/env python3
"""
Experiment 01: Evidence Detection - Run Wrapper
================================================

This wrapper script uses shared infrastructure from _shared/infrastructure/
to run the Evidence Detection experiment.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Experiment 01: Evidence Detection",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
EXPERIMENT 01: EVIDENCE DETECTION
==================================

Implements Evidence Detection capability using document-driven derivation.
This is the baseline experiment establishing core patterns.
...
Examples:
  # Start new run
  python run_experiment.py --project-dir outputs/runs/evidence-test

  # Resume existing run
  python run_experiment.py --project-dir outputs/runs/evidence-test

  # Limit iterations for testing
  python run_experiment.py --project-dir outputs/runs/evidence-test --max-iterations 5
