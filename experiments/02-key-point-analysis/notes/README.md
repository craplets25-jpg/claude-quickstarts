...
Experiment 03 tests whether AI agents can derive working implementations from canonical documentation (diagrams, examples, API docs) without inventing features.
...
- [Experiment Strategy](./EXPERIMENT_03_STRATEGY.md)
- [Manifesto (Core Rules)](./EXP_03_MANIFESTO.md)
...
2. Check EXPERIMENT_03_STRATEGY.md for detailed analysis
