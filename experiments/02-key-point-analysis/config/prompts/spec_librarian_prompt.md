...
- [D] Example script: `../../../_shared/data/reference-examples/debater_python_api/examples/___`
- [E] Response witness: `../../../_shared/data/reference-examples/debater_python_api/examples/___`
- [F] Client file: `../../../_shared/data/reference-examples/debater_python_api/api/clients/___`
...
```json
{
  ...
  "sources": {
    ...
    "example": "../../../_shared/data/reference-examples/debater_python_api/examples/evidence_detection_example.py:16",
    "response": "../../../_shared/data/reference-examples/debater_python_api/examples/evidence_detection_response.txt:1-16",
    "client": "../../../_shared/data/reference-examples/debater_python_api/api/clients/claim_and_evidence_detection_client.py:run (lines 32-36)"
  },
  "input_shape": { ... },
  "output_shape": { ... },
  "invariants": [
