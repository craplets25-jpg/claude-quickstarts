...
Experiment 04 tests whether AI agents can derive working implementations from canonical documentation (diagrams, examples, API docs) without inventing features.
...
- [Experiment Strategy](./EXPERIMENT_04_STRATEGY.md)
- [Manifesto (Core Rules)](./EXP_04_MANIFESTO.md)
...
2. Check EXPERIMENT_04_STRATEGY.md for detailed analysis
