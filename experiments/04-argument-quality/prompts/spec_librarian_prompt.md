...
**For Argument Quality**, use deepwiki-navigator skill to find relevant sections:
- Use capability_scanner.py to find all sections mentioning "Argument Quality"
- Extract those sections with section_extractor.py
- Look for architecture diagrams showing:
