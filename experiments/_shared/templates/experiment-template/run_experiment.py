#!/usr/bin/env python3
"""
Experiment NN: [Capability Name] - Run Wrapper
===============================================

This wrapper script uses shared infrastructure from _shared/infrastructure/
to run the [Capability Name] experiment.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Experiment NN: [Capability Name]",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
EXPERIMENT NN: [CAPABILITY NAME]
================================

Implements [Capability Name] capability using document-driven derivation.
...
Examples:
  # Start new run
  python run_experiment.py --project-dir outputs/runs/test-run

  # Resume existing run
  python run_experiment.py --project-dir outputs/runs/test-run

  # Limit iterations for testing
  python run_experiment.py --project-dir outputs/runs/test-run --max-iterations 5
