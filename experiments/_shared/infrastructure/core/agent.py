...
async def run_autonomous_agent(
    ...
    Args:
        project_dir: Directory for the project run (in outputs/runs/)
        config_dir: Experiment's config directory (contains prompts/, etc.)
        model: Claude model to use
        max_iterations: Maximum number of iterations (None for unlimited)
    """
    # Set prompts directory for this experiment
    from .prompts import set_prompts_dir
    set_prompts_dir(config_dir / "prompts")
    ...
    if session_type == "SPEC LIBRARIAN":
        ...
        copy_spec_to_project(project_dir, config_dir)
        logger.log_decision(
